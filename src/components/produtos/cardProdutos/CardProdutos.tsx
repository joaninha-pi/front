    ...
    <div className="flex flex-col rounded-2xl max-w-sm bg-red-300 bg-opacity-45 shadow-xl overflow-hidden">
      ...
      >
        <img
          src={produto.image}
          alt="Preview Produto"
          className="rounded-t-2xl w-full h-48 object-cover transition-transform transform hover:scale-110"
        />
      </figure>
          ...
          <div className="bg-white rounded-2xl p-6 max-w-lg w-full max-h-screen overflow-y-auto">
            ...
            <div className="flex flex-col items-center space-y-4">
              <img
                src={produto.image}
                alt="Produto"
                className="rounded-2xl max-w-full h-64 object-cover mb-4 transition-transform transform hover:scale-110"
              />
