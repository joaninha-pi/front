        ...
        <img src={produto.image} alt="Preview Produto" className="rounded-t-2xl w-full h-48 object-cover"></img>
          ...
          <div className="flex justify-center gap-2">
            <Link
              ...
              className="text-red-700 border-2 rounded-lg border-opacity-40 border-red-700 font-body font-bold p-2 flex items-center hover:opacity-65 justify-center transition-transform transform"
            >
              Editar produto
            </Link>
            <Link
